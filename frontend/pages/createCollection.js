...
const CreateCollection = ({ navigation }) => {
  ...
  const Brands = Moralis.Object.extend("Brands");
  ...
  const onSave = async () => {
    ...
    console.log('CCCCCCCCCCCCCCCCCCCategory', category)
    ...
    <View style={[styles.root, { backgroundColor: colors.primary }]}>
      <ScrollView style={{ paddingHorizontal: 12 }}>
        ...
        <View style={styles.row}>
          ...
          <Text style={[styles.t2, { color: colors.color7 }]}>New Collection</Text>
        </View>
...

        {
          ...
          <ModalSuccess
            title={'Success'}
            description={'New Collection is created successfully'}
